...
describe('test /classes', () => {
    ...
    describe('POST /', () => {
        ...
        beforeAll(async () => {
            ...
            // create mock Class
            await db.createClass({ creator: user1._id, ...test_class });
        });
                ...
                await request(app)
                    ...
                    .then(({ body: { success, message } }) => {
                        ...
                        expect(message).toEqual(
                            'wrong id format, check id length',
                        );
                    });
            });
    ...
    describe('POST /:id', () => {
        ...
        beforeAll(async () => {
            ...
            await Class.findById(class1._id).then((_class) => {
        ...
        it('should return 201 and return successfully attended class', async function () {
            await request(app)
                ...
                .then(({ body: { success, message } }) => {
                    ...
                    expect(message).toEqual(
                        'successfully attended class : ' + class1.name,
                    );
                });
        });
            ...
            it('should return 400 and owner cant register its class', async function () {
                await request(app)
                    ...
                    .then(({ body: { success, message } }) => {
                        expect(success).toBeFalsy();
                        expect(message).toEqual(
                            "owner can't register it's class",
                        );
                    });
            });
            ...
            await request(app)
                ...
                .then(({ body: { success, message, changed } }) => {
                    ...
                    expect(changed).toEqual(
                        ['name', 'point', 'type', 'description'].join(', '),
                    );
                });
        });
            ...
            it('should return 400 and only can be modified by teacher', async function () {
                await request(app)
                    ...
                    .then(({ body: { success, message } }) => {
                        expect(success).toBeFalsy();
                        expect(message).toEqual(
                            'only can be modified by teacher',
                        );
                    });
            });
        ...
        it('should return 200 and successfully deleted', async function () {
            ...
            await request(app)
                ...
                .then(({ body: { success, message } }) => {
                    expect(success).toBeTruthy();
                    expect(message).toEqual(
                        'successfully deleted : ' + class1.name,
                    );
                });
        });
