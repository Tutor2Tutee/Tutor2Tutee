    ...
    return (
        <section className="feature__container">
            <div className="feature__main">
                <div className="feature__info--container">
                    <div className="feature__info">
                        <h1 className="feature__h1">{Locale.feature.feature_recorded_head[language]}</h1>
            ...
            <div className="feature__main">
                ...
                <div className="feature__info--container">
                    <div className="feature__info feature__info--paddingleft">
                        <h1 className="feature__h1">{Locale.feature.feature_meeting_head[language]}</h1>
            ...
            <div className="feature__main">
                <div className="feature__info--container">
                    <div className="feature__info">
                        <h1 className="feature__h1">{Locale.feature.feature_attandance_head[language]}</h1>
            ...
            <div className="feature__main">
                ...
                <div className="feature__info--container">
                    <div className="feature__info feature__info--paddingleft">
                        <h1 className="feature__h1">{Locale.feature.feature_rating_head[language]}</h1>
