    ...
    const Drawer = (
        ...
        >
            <ul onClick={props.toggleSD}>
                ...
                {isAuth && (
                    <React.Fragment>
                        <NavLink sd={true} href="/class">
                            {language === 'kor' ? '클래스' : 'Classes'}
                        </NavLink>
                        <NavLink sd={true} href="/logout">
            ...
            <div className="sd-theme-btn-container">
                <div
                    ...
                    className={`sd-theme-btn ${!isDark ? 'light' : 'dark'}`}
                >
                    <button
                        className={`sd-slider ${!isDark ? 'light' : 'dark'}`}
                    ></button>
