    ...
    return (
        <nav className="header__nav">
            <ul className="header__ul">
                ...
                <NavLink href="/feature" >{language === "kor" ? "기능" :"Feature"}</NavLink>
                <NavLink href="/about" >{language === "kor" ? "소개" :"About"}</NavLink>
                {
                    isAuth && (<React.Fragment> 
                    <NavLink href="/class" >{language === "kor" ? "클래스" : "Classes"}</NavLink>
                    <NavLink href="/logout" >{language === "kor" ? "로그아웃" : "Logout"}</NavLink>
                    </React.Fragment>
                    )
                }
                {
                    ...
                    <NavLink href="/signup" >{language === "kor" ? "회원가입" : "Signup"}</NavLink>
                    </React.Fragment>
                    )
                }
            </ul>
